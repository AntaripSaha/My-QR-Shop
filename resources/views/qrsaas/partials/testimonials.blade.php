...
<section id="testimonials" class="section section-sm">
    <div class="container">
        <div class="row justify-content-center mb-5 mb-lg-3">
            ...
            <i class="fas fa-edit mr-2 text-primary ckedit_btn" type="button" style="display: none"></i><h1 class="h2 font-weight-bolder mb-4 ckedit" key="testimonials_title" id="testimonials_title">{{ __('qrlanding.testimonials_title') }}</h1>
